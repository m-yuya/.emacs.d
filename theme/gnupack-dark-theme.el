...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-type-face                  ((t (:foreground ,red-basic    :default t        ))))
   ...
   `(font-lock-function-name-face         ((t (:foreground ,violet-basic :default t        ))))
   ...
   `(isearch      ((t (:foreground ,gray-05 :background ,red-light ))))
   ;; 見づらいので変更
   ...
   ;; CUI時にlinum-modeの数字が表示されなくなるのでコメントアウト
   ;; `(shadow            ((t (:foreground ,gray-35))))
   `(fringe            ((t (:foreground ,gray-45 :background ,gray-50))))
   ...
   ;; CUI時にauto-completeの候補の表示が崩れるのでコメントアウト
